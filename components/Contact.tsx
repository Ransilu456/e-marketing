    ...
    <section id="contact" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-display font-bold mb-3 text-slate-900">
            Quick contact
          </h2>
          <p className="text-slate-600 max-w-2xl mx-auto">
            Have a question or want to start a project? Reach out and we&apos;ll
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-slate-900 hover:accent transition-colors"
                >

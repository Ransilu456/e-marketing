    ...
    <main className="min-h-screen bg-white text-black py-24 px-6 md:px-16" style={{ fontFamily: "Poppins, sans-serif" }}>
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          Creative <span className="text-[#4AEA45]">Posters</span>
        </h1>
        <p className="text-gray-700 text-lg md:text-xl max-w-3xl mx-auto">
          We design attention-grabbing posters and visuals that amplify your brand’s message and captivate your audience.
        </p>
      </motion.div>
      ...
      >
        <p>
          Our creative design team produces compelling visuals that communicate emotion and story, perfect for both print and digital campaigns.
        </p>

        <ul className="list-disc list-inside space-y-2">
          <li>Custom designs for ads & promotions</li>
          <li>Social media campaign graphics</li>
          <li>Event & product posters</li>

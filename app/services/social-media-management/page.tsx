...
const features = [
  {
    ...
    desc: "We create tailored content calendars designed to engage your audience and grow organically.",
    icon: ThumbsUp,
  },
  {
    title: "Data-Driven Campaigns",
    desc: "Our ad strategies leverage analytics to maximize ROI and track every impression and click.",
    icon: BarChart3,
  },
  {
...
export default function SocialMediaPage() {
  return (
    <main className={`min-h-screen bg-white text-[${TEXT_COLOR}] relative overflow-hidden font-sans`}>
      ...
      <section className="relative px-6 md:px-16 pt-28 pb-36 lg:pt-36 lg:pb-48 flex flex-col-reverse md:flex-row items-center gap-16 max-w-7xl mx-auto">
        ...
        >
          <h1 className={`text-5xl lg:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-[${HEADING_COLOR}]`}>
            ...
            <span className={`text-[${PRIMARY_COLOR}]`}>That Drives Results</span>
          </h1>
          <p className="text-gray-600 text-xl mb-10 leading-relaxed max-w-lg">
            ...
            we help businesses build their audience, boost engagement, and grow brand presence on every platform.
          </p>
          <Link
            href="/#contact"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-xl">
              We handle everything — from strategy to execution — so your brand shines online.
            </p>
          </div>
      ...
      <section className="py-24 px-6 md:px-16 overflow-hidden relative max-w-7xl mx-auto">
        <div className="max-w-full mx-auto mb-16 text-center">
          ...
          <p className="text-gray-600 text-xl">
            See how we’ve transformed brands with impactful campaigns.
          </p>
        </div>

        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 relative z-10">
          ...
          <div className="flex-1 text-center lg:text-left reveal-up">
            ...
            <h1 className="text-5xl lg:text-7xl font-semibold mb-6 tracking-tight leading-[1.1] text-gray-900">
              ...
              <span className="relative inline-block px-2">
                <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-red-500 to-red-600 animate-gradient">
                  Websites
                </span>
          ...
          <div className="flex-1 w-full flex justify-center lg:justify-end reveal-up delay-200">
            <div className="relative w-full max-w-lg aspect-4/3 group perspective-1000">
              <div className="absolute -inset-4 bg-gradient-to-tr from-red-200 via-red-100 to-transparent rounded-4xl blur-3xl opacity-60 group-hover:opacity-80 transition duration-700"></div>

              <div className="relative w-full h-full rounded-2xl overflow-hidden border border-red-200 shadow-2xl bg-white group-hover:rotate-y-2 group-hover:rotate-x-2 transition duration-700 ease-out transform-style-3d">
                {/* Window Bar */}

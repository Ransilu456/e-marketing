    ...
    <main className={`min-h-screen bg-white text-[${TEXT_COLOR}] `}>
      <section className="px-6 md:px-16 pt-28 pb-16 max-w-6xl mx-auto">
        ...
        <h1
          ...
          className={`text-4xl md:text-5xl font-bold text-[${HEADING_COLOR}] mb-4`}
        >
          {project.title}
        </h1>
        ...
        <p
          ...
          className="text-gray-600 text-lg leading-relaxed mb-10 max-w-3xl"
        >
          {project.description}
        </p>
      ...
      <section className="px-6 md:px-16 py-24 bg-[#f9fafb]">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-700 leading-relaxed text-lg mb-12">
            This project demonstrates our attention to performance, responsive
            design, and clean UI/UX. Built with modern frameworks and optimized
            for SEO and scalability.
          </p>
